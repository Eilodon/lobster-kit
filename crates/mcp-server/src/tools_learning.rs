...
impl EidolonMcpServer {
    pub(crate) async fn handle_record_outcome(&self, params: serde_json::Value) -> serde_json::Value {
    ...
    pub(crate) async fn handle_dream_conversation(&self, params: serde_json::Value) -> serde_json::Value {
