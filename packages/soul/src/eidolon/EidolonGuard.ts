...
export class EidolonGuard {
    ...
    constructor(
        ...
        config: GuardConfig = {
            ...
            minConfidence: 70,
            riskParameters: {
                maxPositionSize: RiskConfigPreset.base.maxPositionSize,
                maxDrawdown: RiskConfigPreset.base.maxDrawdown,
                minConfidence: RiskConfigPreset.base.minConfidence,
                cooldownPeriod: RiskConfigPreset.base.cooldownPeriod
            },
