import { PublicClient, encodeFunctionData, parseAbi, formatEther } from 'viem';
...
export class GasModule {
  ...
  async getBNBPrice(): Promise<number> {
    ...
    const emergencyFallback = 600;
    console.error('❌ All APIs failed to fetch BNB price. Using emergency fallback.');
